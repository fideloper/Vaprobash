...
SO_VERSION=`lsb_release -c | awk -F':' '{ print $2 }' | sed 's/\t//g'`
...
sudo add-apt-repository "deb [arch=amd64,i386,ppc64el] http://tedeco.fi.upm.es/mirror/mariadb/repo/$MARIADB_VERSION/ubuntu $SO_VERSION main"
